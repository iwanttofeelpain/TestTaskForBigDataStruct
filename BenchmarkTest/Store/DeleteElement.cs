...
namespace BenchmarkTest.StoreTest
{
    ...
    public class DeleteElement
    {
        ...
        private List<User> testUserForDelete;
        ...
        public void IterationSetup1()
        {
            ...
            this.testUserForDelete = new List<User>() {testUsers.First()};
        ...
        {
            foreach (var user in testUserForDelete)
            {
                this.data.DeleteUser(user.UserName);
            }
        }
